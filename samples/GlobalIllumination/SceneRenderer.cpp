...
void SceneRenderer::RenderForVoxelization(NVRHI::DrawCallState &state, VXGI::IGlobalIllumination *pGI, const VXGI::Box3f *clippingBoxes, uint32_t numBoxes, DirectX::XMFLOAT3 const &clipmap_anchor, const VXGI::float4x4 &viewProjMatrix, MaterialCallback *onChangeMaterial)
{
    ...
    constants.viewport_depth_direction_view_matrices[0] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 0);
    constants.viewport_depth_direction_view_matrices[1] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 1);
    constants.viewport_depth_direction_view_matrices[2] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 2);

    constants.clipmap_stack_level_projection_matrices[0] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(0);
    constants.clipmap_stack_level_projection_matrices[1] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(1);
    constants.clipmap_stack_level_projection_matrices[2] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(2);
    constants.clipmap_stack_level_projection_matrices[3] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(3);
    constants.clipmap_stack_level_projection_matrices[4] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(4);
