    ...
    in float2 in_interpolated_texcoord : LOCATION5)
{
    ...
    brx_voxel_cone_tracing_voxelization_store_data(in_viewport_depth_direction_index, in_clipmap_stack_level_index, float3(in_position.x, BRX_VCT_CLIPMAP_MAP_SIZE - in_position.y, in_position.z * BRX_VCT_CLIPMAP_MAP_SIZE), in_sample_mask, opacity, shading_normal_world_space, float3(0.0, 0.0, 0.0));
}
