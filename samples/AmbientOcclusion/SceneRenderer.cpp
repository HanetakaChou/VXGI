    ...
    MaterialCallback *onChangeMaterial)
{
    ...
    globalConstants.viewport_depth_direction_view_matrices[0] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 0);
    globalConstants.viewport_depth_direction_view_matrices[1] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 1);
    globalConstants.viewport_depth_direction_view_matrices[2] = brx_voxel_cone_tracing_voxelization_compute_viewport_depth_direction_view_matrix(clipmap_center, 2);

    globalConstants.clipmap_stack_level_projection_matrices[0] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(0);
    globalConstants.clipmap_stack_level_projection_matrices[1] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(1);
    globalConstants.clipmap_stack_level_projection_matrices[2] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(2);
    globalConstants.clipmap_stack_level_projection_matrices[3] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(3);
    globalConstants.clipmap_stack_level_projection_matrices[4] = brx_voxel_cone_tracing_voxelization_compute_clipmap_stack_level_projection_matrix(4);
