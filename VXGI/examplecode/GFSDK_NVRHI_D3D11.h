...
extern ID3D11ComputeShader *g_pMyConeTracingCS;
extern NVRHI::TextureHandle g_clipmap_opacity_texture;
extern NVRHI::TextureHandle g_clipmap_illumination_texture;
extern uint32_t g_MyWidth;
extern uint32_t g_MyHeight;
...
namespace NVRHI
{
  ...
  public:
    ...
    void debugBeginEvent(char const* name);
    void debugEndEvent();
  };
